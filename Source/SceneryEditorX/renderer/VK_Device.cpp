...
namespace VKEngine
{
    ...
    */
        ...
        void *data)
    {
        ...
        VkBufferCreateInfo bufferCreateInfo = VKEngine::initializers::bufferCreateInfo(usageFlags, size);
        ...
        if (data != nullptr)
        {
            ...
            {
                VkMappedMemoryRange mappedRange = VKEngine::initializers::mappedMemoryRange();
    ...
    */
    void VulkanDevice::copyBuffer(VKEngine::Buffer *src, VKEngine::Buffer *dst, VkQueue queue, VkBufferCopy *copyRegion)
    {
    ...
    */
    ...
    {
        VkCommandBufferAllocateInfo cmdBufAllocateInfo = VKEngine::initializers::commandBufferAllocateInfo(pool, level, 1);
        VkCommandBuffer cmdBuffer;
        VK_CHECK_RESULT(vkAllocateCommandBuffers(logicalDevice, &cmdBufAllocateInfo, &cmdBuffer));
        // If requested, also start recording for the new command buffer
        if (begin)
        {
            VkCommandBufferBeginInfo cmdBufInfo = VKEngine::initializers::commandBufferBeginInfo();
    ...
    */
    void VulkanDevice::flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, VkCommandPool pool, bool free)
    {
        ...
        VkSubmitInfo submitInfo = VKEngine::initializers::submitInfo();
        submitInfo.commandBufferCount = 1;
        submitInfo.pCommandBuffers = &commandBuffer;
        // Create fence to ensure that the command buffer has finished executing
        VkFenceCreateInfo fenceInfo = VKEngine::initializers::fenceCreateInfo(VK_FLAGS_NONE);
        VkFence fence;
