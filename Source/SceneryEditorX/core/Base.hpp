...
using RID  = uint32_t; // Resource Identifier, alias for unsigned 32-bit integer
#ifndef UUID_DEFINED
#define UUID_DEFINED
using UUID = uint64_t; // Universally Unique Identifier, alias for unsigned 64-bit integer
#endif
