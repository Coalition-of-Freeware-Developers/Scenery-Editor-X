#include "imgui.h"
#include "UI.h"
//#include "../platform/windows/FileManager.h"
//#include <string>
...
namespace SceneryEditorX::UI{
    void MainMenuBar()
    {
    	if (ImGui::BeginMainMenuBar())
        {
    	    if (ImGui::BeginMenu("File"))
    	    {
                ...
                if (ImGui::BeginMenu("Import", "Ctrl+I"))
                {
                    ...
                    if (ImGui::MenuItem("Convert WED Project", nullptr))
                    {
                        // Convert WED project to Scenery Editor X project format
                    }
                ...
                if (ImGui::BeginMenu("Export", "Ctrl+I"))
                {
                    ...
                    ImGui::BeginMenu("Export to File");
    	...
    	if (ImGui::BeginMenu("Options"))
    	{
    		...
    		if (ImGui::MenuItem("Toggle Snaps", "S", &enabled))
               {
                   /* Do something here */
               }
