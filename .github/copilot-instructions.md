...
- This renderer must not use or include ray tracing or path tracing code; remove any ray/path-tracing leftovers from renderer passes, shaders, descriptors/ descriptor sets, pipelines, etc.
