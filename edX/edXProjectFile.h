...
namespace ProjectFile
{
    ...
    class Group
    {
        ...
        std::vector<std::string> Tags; //Tags for the object. These are user generated and used for selecting/editing other items with the same tag.
    };
    ...
    public:
        ...
        bool PickWalls{ true };       //True if the walls are picked, if false X-Plane will pick them at runtime. We will default to wall idx 0.
    };
