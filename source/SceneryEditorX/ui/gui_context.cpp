...
namespace SceneryEditorX
{
	...
	ContextHandler *ContextHandler::Create()
    {
        switch (GraphicsEngine::Current())
		{
			case RendererType::None:    return nullptr;
			case RendererType::Vulkan:  return hnew EditorUI();
		}
		EDITOR_LOG_ERROR("Renderer API not supported!");
        return nullptr;
    }

    void ContextHandler::SetDarkThemeColors()
    {
    ...
    void ContextHandler::SetDarkThemeV2Colors()
    {
    ...
    void ContextHandler::AllowInputEvents(bool allowEvents)
    {
    }
