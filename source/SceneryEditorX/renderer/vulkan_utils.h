...
namespace SceneryEditorX
{
	...
	*/
	...
	namespace Utils
	{
		 ...
		 */
		const char* DebugSeverityString(VkDebugUtilsMessageSeverityFlagBitsEXT severity);
		 ...
		 */
		const char* DebugType(VkDebugUtilsMessageTypeFlagsEXT type);
		 ...
		 */
		const char* VulkanErrorString(VkResult errorCode);
		 ...
		 */
		const char* VulkanFormatString(VkFormat format);
		 ...
		 */
		const char* ColorSpaceString(VkColorSpaceKHR colorSpace);
		 ...
		 */
		const char* QueueFlagsString(VkQueueFlags flags);
		 ...
		 */
		const char* ObjectTypeToString(VkObjectType objectType);
		 ...
		 * @return The corresponding Vulkan compare operator.
		 */
		VkCompareOp GetVulkanCompareOperator(CompareFunc compareOp);

        /**
         * @brief Get the size in bytes of a given shader data type.
