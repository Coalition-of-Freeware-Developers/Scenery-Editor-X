...
namespace SceneryEditorX
{
    ...
    public:
		...
		[[nodiscard]] virtual ResourceDescriptorInfo GetDescriptorResourceInfo() const override { return (ResourceDescriptorInfo)&m_DescriptorImageInfo; }
		[[nodiscard]] const VkDescriptorImageInfo &GetDescriptorInfo() const { return *(VkDescriptorImageInfo*)GetDescriptorResourceInfo(); }
