...
namespace SceneryEditorX
{
	...
	public:
	    ...
	    [[nodiscard]] VkBuffer GetBuffer(uint32_t frame) const
	    {
	        return m_Buffers[frame].resource->buffer;
	    }
	    ...
	    [[nodiscard]] const VkDescriptorBufferInfo &GetDescriptor(uint32_t frame) const
	    {
