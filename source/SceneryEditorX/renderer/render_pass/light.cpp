...
namespace SceneryEditorX
{
    ...
    void RenderPass::Pass_Light(CommandManager *cmd_list, const bool is_transparent_pass)
    {
        ...
        cmd_list->BeginTimeblock(pso.name);
        {
            ...
            cmd_list->SetTexture(bindingsUav::tex_sss, GetRenderTarget(RenderTarget::SSS));
            ...
            cmd_list->SetTexture(bindingsUav::tex,     light_diffuse);
            cmd_list->SetTexture(bindingsUav::tex2,    light_specular);
            cmd_list->SetTexture(bindingsUav::tex3,    light_shadow);
            cmd_list->SetTexture(bindingsUav::tex4,    light_volumetric);
