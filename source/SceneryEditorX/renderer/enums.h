...
namespace SceneryEditorX
{
    ...
    enum class VertexFormat : uint32_t
    {
        ...
        Position2D_UV_Color4				= 10,	// Vec2 position + Vec2 uv + Vec4 color
    ...
    /**
	 * @brief Converts ShaderType enum to Vulkan shader stage flag bits
	 * 
	 * Maps the SceneryEditorX ShaderType enumeration values to their corresponding
	 * Vulkan VkShaderStageFlagBits values for use in descriptor set bindings and
	 * pipeline stage specifications.
	 * 
	 * @param type The shader type to convert
	 * @return uint32_t Vulkan shader stage flag bits as a bitmask
	 * 
	 * @note Returns 0 for invalid or unsupported shader types
	 */
    static uint32_t ShaderTypeToMask(ShaderType type)
    {
        switch (type)
        {
        case ShaderType::Vertex:				return VK_SHADER_STAGE_VERTEX_BIT;
        case ShaderType::TesselationControl:	return VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT;
        case ShaderType::TesselationEval:		return VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT;
        case ShaderType::Geometry:				return VK_SHADER_STAGE_GEOMETRY_BIT;
        case ShaderType::Fragment:				return VK_SHADER_STAGE_FRAGMENT_BIT;
        case ShaderType::Compute:				return VK_SHADER_STAGE_COMPUTE_BIT;
        case ShaderType::AllGraphics:			return VK_SHADER_STAGE_ALL_GRAPHICS;
        case ShaderType::Raygen:				return VK_SHADER_STAGE_RAYGEN_BIT_KHR;
        case ShaderType::MaxEnum:				return VK_SHADER_STAGE_FLAG_BITS_MAX_ENUM;
        default:
            return 0;
        }
    }
