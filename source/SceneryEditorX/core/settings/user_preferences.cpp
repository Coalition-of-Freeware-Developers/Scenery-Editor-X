...
* -------------------------------------------------------
*/
#include <SceneryEditorX/core/settings/user_preferences.h>
#include <fstream>
#include <sstream>
...
{
	UserPreferencesSerializer::UserPreferencesSerializer(const Ref<UserPreferences>& preferences) : m_Preferences(preferences)
	{
	}
