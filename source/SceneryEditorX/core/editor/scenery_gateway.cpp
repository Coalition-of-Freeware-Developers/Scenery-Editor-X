...
namespace SceneryEditorX
{
    ...
    bool SceneryGateway::SaveToFile(const std::string &filePath) const
    {
        ...
        {
            SEDX_CORE_ERROR_TAG("SCENERY GATEWAY", "Failed to save gateway data to file: {}", e.what());
            return false;
        }
    }
    ...
    bool SceneryGateway::LoadFromFile(const std::string &filePath) const
    {
        ...
        {
            SEDX_CORE_ERROR_TAG("SCENERY GATEWAY", "Failed to load gateway data from file: {}", e.what());
            return false;
        }
    }
